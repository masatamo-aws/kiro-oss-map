/**
 * Kiro OSS Map v2.1.0 - TypeScript版全サービス起動スクリプト
 * 開発・テスト用のマイクロサービス群起動（TypeScript対応）
 */
...
console.log('🚀 Starting Kiro OSS Map v2.1.0 TypeScript Microservices...');
...
setTimeout(() => {
  console.log('\n' + '=' .repeat(60));
  console.log('🎉 All TypeScript services started successfully!');
  console.log('\n📋 Service URLs:');
  ...
  console.log('   ✅ Map Service: Built successfully');
  console.log('   ⚠️  Search Service: Using simple version (TypeScript build pending)');
  console.log('\n' + '=' .repeat(60));
}, 4000);

// グレースフルシャットダウン
function shutdown() {
  console.log('\n🛑 Shutting down all TypeScript services...');
  ...
  setTimeout(() => {
    console.log('✅ All TypeScript services stopped.');
    process.exit(0);
  }, 2000);
}
